...
import heroImage from "../../public/myPicture.png";
  ...
  return (
    <section className="md:flex w-full md:flex-row-reverse px-4 mt-6">
      ...
      <div className="mt-8 md:mt-16 md:w-1/2 text-center space-y-4">
        ...
        <h2 className="font-bold text-4xl text-teal-600">Santhosh Guntha</h2>
        ...
        <p className="md:pt-4">
          ...
          based in United States. Working towards creating software that
